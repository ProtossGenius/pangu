...
// CODES_CLASS(Var);
CODES_CLASS(While, WAIT_CONDITION, WAIT_ACTION);
CODES_CLASS(For, WAIT_HEADER, WAIT_IN_KEYWORD, WAIT_COMMA_OR_IN, WAIT_ITER_EXPR, CHECK_ITER_CALL, CHECK_ITER_DOT, WAIT_ACTION);
CODES_CLASS(Switch, WAIT_CONDITION, WAIT_ACTION);
CODES_CLASS(Case, WAIT_VALUE, WAIT_COLON, WAIT_ACTION);
CODES_CLASS(Match, WAIT_CONDITION, WAIT_ACTION);
// CODES_CLASS(Goto);
// CODES_CLASS(Do);
CODES_CLASS(Normal, WAIT_MID_OPER, WAIT_RIGHT, PRE_VIEW_NEXT);
CODES_CLASS(Lambda, EXPECT_PARAMS, EXPECT_BODY_OR_RETURN, EXPECT_BODY);
